  ...
  var raycaster = new THREE.Raycaster();
   ...
   $('body').on('touchmove mousemove touchstart',function(e) {
      ...
      if (intersects.length>0){
        var ee = intersects[0].point.multiplyScalar(-resolution/size);
        ee.add(new THREE.Vector2(resolution*0.5, resolution*0.5));
        P.grid.setMousePos(ee, 1.0);
